 ...
 * @property episodes The [Episode]s wheres this character plays.
 * @property status The current [CharacterStatus] of the character (Alive, Dead, or Unknown).
 ...
 * @property gender The [CharacterGender] of the character.
 * @property origin The origin location of the character, represented as a [LocationPreview].
